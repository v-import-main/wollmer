...
if ( true !== apply_filters( 'itbub_hide_custom_backup_directory_option', false ) ) {
	$settings_form->add_setting(
		array(
			...
			'after'  => ' <span class="description">' . __( 'Blank for default', 'it-l10n-backupbuddy' ) . ':</span>&nbsp; <span class="code" style="background: #EAEAEA; white-space: normal;">' . esc_html( backupbuddy_core::_getBackupDirectoryDefault() ) . '</span></span>',
		)
	);
}
