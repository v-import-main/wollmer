    ...
    var f = {
            ...
            init_payment_methods: function() {
                var e = g(".woocommerce-checkout").find('input[name="payment_method"]'),
                    t = (1 === e.length && e.eq(0).hide(), f.selectedPaymentMethod && g("#" + f.selectedPaymentMethod).prop("checked", !0), 0 === e.filter(":checked").length && e.eq(0).prop("checked", !0), e.filter(":checked").eq(0).prop("id"));
            ...
            update_checkout_action: function(e) {
                ...
                f.xhr && f.xhr.abort(), 0 !== g("form.checkout").length && (e = void 0 !== e ? e : {
                ...
                }, a = t = g("#billing_country").val(), u = o = g("#billing_state").val(), d = c = g(":input#billing_postcode").val(), s = i = g("#billing_city").val(), m = n = g(":input#billing_address_1").val(), l = r = g(":input#billing_address_2").val(), p = g(f.$checkout_form).find(".address-field.validate-required:visible"), h = !0, p.length && p.each(function() {
                    "" === g(this).find(":input").val() && (h = !1)
                }), g("#ship-to-different-address").find("input").is(":checked") && (a = g("#shipping_country").val(), u = g("#shipping_state").val(), d = g(":input#shipping_postcode").val(), s = g("#shipping_city").val(), m = g(":input#shipping_address_1").val(), l = g(":input#shipping_address_2").val()), !(p = {
                ...
                }), p.shipping_method = _), g(".woocommerce-checkout-payment, .woocommerce-checkout-review-order-table, .js-update-shipment, .js-update-payment").block({
                    message: null,
                    overlayCSS: {
                        background: "#fff",
                        opacity: .6
                    ...
                    data: p,
                    success: function(e) {
                        let shipment = e.fragments['.woocommerce_order_review_inner'];
                        let payment = e.fragments['.woocommerce_checkout_payment_content'];

                        $('.js-update-shipment').html($(shipment))
                        $('.js-update-payment').html($(payment))
                        initDelivery()

                        let selectVal = $("#billing_state_field #billing_state option:selected").val()
                        if (selectVal !== doubleShipment) {
                            $('#delivery #billing_address_1').val(selectVal)
                            $('#delivery #billing_address_1').focus();
                            doubleShipment = selectVal;
                        }
                        var t, o;
            ...
            submit: function() {
                ...
                var o = g(this);
                return o.is(".processing") || !1 !== o.triggerHandler("checkout_place_order", [f]) && !1 !== o.triggerHandler("checkout_place_order_" + f.get_payment_method(), [f]) && (o.addClass("processing"), f.blockOnSubmit(o), f.attachUnloadEventsOnSubmit(), g.ajaxSetup({
                    dataFilter: function(e, t) {
                        return "json" !== t || f.is_valid_json(e) || (null !== (t = e.match(/{"result.*}/)) && f.is_valid_json(t[0]) ? (console.log("Fixed malformed JSON. Original:"), console.log(e), e = t[0]) : console.log("Unable to fix malformed JSON")), e
                    }
                }), g.ajax({
                    type: "POST",
                    ...
                    success: function(e) {
                        ...
                        try {
                            if ("success" !== e.result || !1 === o.triggerHandler("checkout_place_order_success", [e, f])) throw "failure" === e.result ? "Result failure" : "Invalid response"; - 1 === e.redirect.indexOf("https://") || -1 === e.redirect.indexOf("http://") ? window.location = e.redirect : window.location = decodeURI(e.redirect)
                        } catch (t) {
                            !0 === e.reload ? window.location.reload() : (!0 === e.refresh && g(document.body).trigger("update_checkout"), e.messages ? f.submit_error(e.messages) : f.submit_error('<div class="woocommerce-error">' + wc_checkout_params.i18n_checkout_error + "</div>"))
                        }
                    },
                    error: function(e, t, o) {
                        f.detachUnloadEventsOnSubmit(), f.submit_error('<div class="woocommerce-error">' + (o || wc_checkout_params.i18n_checkout_error) + "</div>")
                    }
                })), !1
            },
        ...
        e = {
            ...
            submit: function() {
                ...
                return o.is(".processing") || (o.addClass("processing").block({
                    ...
                    data: t,
                    success: function(e) {
                        g(".woocommerce-error, .woocommerce-message").remove(), o.removeClass("processing").unblock(), e && (o.before(e), o.slideUp(), g(document.body).trigger("applied_coupon_in_checkout", [t.coupon_code]), g(document.body).trigger("update_checkout", {
            ...
            remove_coupon: function(e) {
                ...
                g.ajax({
                    ...
                    data: o,
                    success: function(e) {
                        g(".woocommerce-error, .woocommerce-message").remove(), t.removeClass("processing").unblock(), e && (g("form.woocommerce-checkout").before(e), g(document.body).trigger("removed_coupon_in_checkout", [o.coupon]), g(document.body).trigger("update_checkout", {
                            update_shipping_method: !1
