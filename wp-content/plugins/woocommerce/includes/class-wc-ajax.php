...
class WC_AJAX {
	...
	public static function update_order_review() {
        ...
        // Get checkout payment fragment new.
        ob_start();
        woocommerce_checkout_payment_content();
        $woocommerce_checkout_payment_content = ob_get_clean();

        // Get checkout payment fragment inner.
        ob_start();
        woocommerce_order_review_inner();
        $woocommerce_order_review_inner = ob_get_clean();
			...
			array(
				...
				'fragments' => apply_filters(
					...
					array(
                        ...
                        '.woocommerce_checkout_payment_content' => $woocommerce_checkout_payment_content,
						'.woocommerce_order_review_inner' => $woocommerce_order_review_inner,
					)
				),
			)
		);
