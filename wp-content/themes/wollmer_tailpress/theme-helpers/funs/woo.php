...
function fdev_remove_all_checkout_fields($checkout_fields){
    ...
    $checkout_fields[ 'order' ][ 'order_comments' ][ 'rows' ] = 4;
    ...
    $checkout_fields[ 'order' ][ 'billing_address_1' ][ 'priority' ] = 2;
...
function change_woocommerce_field_markup($field, $key, $args, $value) {
    ...
    // $display_cur = $stat_cur !== '' ? '' : 'style="display:none"';
    // $display_pvz = $stat_pvz !== '' ? '' : 'style="display:none"';

    $display_cur = $stat === 'cur' ? '' : 'style="display:none"';
    $display_pvz = $stat === 'pvz' ? '' : 'style="display:none"';
